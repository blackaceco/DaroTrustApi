...
class StorytellingSeeder extends Seeder
{
    ...
    {
        // # ---> 45
        // $this->bannerFieldsArrayGenerator(9, "banner", [8]);

        // # ---> 52
        $this->storytellingFieldsArrayGenerator(10, "storytelling", [8], "storytelling/2.jpg", "storytelling/1.jpg", "Storytelling Title", "عنوان رواية القصص", "ناونیشانی چیرۆک");
        
        // # ---> 53
        $this->storytellingFieldsArrayGenerator(10, "storytelling", [8], "storytelling/4.jpg", "storytelling/3.jpg", "Storytelling Title", "عنوان رواية القصص", "ناونیشانی چیرۆک");

        // # ---> 54
        $this->storytellingFieldsArrayGenerator(10, "storytelling", [8], "storytelling/5.jpg", "storytelling/8.jpg", "Storytelling Title", "عنوان رواية القصص", "ناونیشانی چیرۆک");

        // # ---> 55
        $this->storytellingFieldsArrayGenerator(10, "storytelling", [8], "storytelling/6.jpg", "storytelling/1.jpg", "Storytelling Title", "عنوان رواية القصص", "ناونیشانی چیرۆک");
        
        // # ---> 56
        $this->storytellingFieldsArrayGenerator(10, "storytelling", [8], "storytelling/7.jpg", "storytelling/3.jpg", "Storytelling Title", "عنوان رواية القصص", "ناونیشانی چیرۆک");
    ...
    private function storytellingFieldsArrayGenerator($schemaId, $featureTitle, $pageGroupIds, $gallery, $image, $title_en, $title_ar, $title_ku)
    {
        $details = [];
